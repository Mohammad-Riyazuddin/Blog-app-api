...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		return new ApiInfo("Blog Backend ", "Mohammad Riyazuddin is the owner of all these api's", "1.0",
				"Terms of Service", new Contact("Mohammad Riyazuddin", "", "riozon1234@gmail.com"), "License of API's",
				"API License URL here", Collections.emptyList());
	}
}
